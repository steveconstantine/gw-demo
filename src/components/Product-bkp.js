  ...
  render() {
    ...
    return (
      <div>
          ...
          parentPath='/'
          enabled={this.props.isSliding == false ? true : false}
          component={Product}
          props={{
          ...
          handleImageLoaded: this.props.handleImageLoaded
              ...
              <BackgroundImage style={styles.homeBackground} src={variantImage} placeholder={variantImage} key={this.props.product.name}>
                <div className={this.props.cartOpen == true ? "invis opacity_animation" : "vis opacity_animation"} style={styles.titleAppearance}>
